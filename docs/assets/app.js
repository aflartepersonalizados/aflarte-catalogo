const products=[
{id:'alfabeto',name:'Alfabeto Sensorial',price:'R$ 49,54',cat:'sensoriais',label:'Sensoriais',img:'assets/alfabeto.webp',gallery:['assets/gallery/alfabeto-1.webp','assets/gallery/alfabeto-2.webp'],short:'Letras texturizadas para aprender brincando.',desc:'Alfabeto sensorial em impressão 3D com letras coloridas e diferentes texturas para explorar o tato e tornar o aprendizado mais divertido.',extra:'Ideal para atividades educativas e exploração sensorial. Recomendado para maiores de 3 anos.\n[[AFL_SHIP:{"weight_g":88,"length_cm":15,"width_cm":10,"height_cm":6}]]'},
{id:'bolha',name:'Bolha Infinita',price:'Grande R$ 19,00 • Pequena R$ 10,00',variants:[{id:'grande',label:'Grande — 9 clicks',price:'R$ 19,00',shipping:{weight_g:37,length_cm:6,width_cm:6,height_cm:2}},{id:'pequena',label:'Pequena — 4 clicks',price:'R$ 10,00',shipping:{weight_g:14,length_cm:3.5,width_cm:3.5,height_cm:2}}],cat:'sensoriais',label:'Sensoriais',img:'assets/bolha.webp',gallery:['assets/gallery/bolha-1.webp','assets/gallery/bolha-2.webp'],short:'Aperte, explore e comece de novo.',desc:'Brinquedo tátil com botões que podem ser pressionados repetidamente. Uma opção compacta para coordenação motora fina, atenção e exploração tátil.',extra:'Disponível em dois tamanhos: grande com 9 clicks e pequeno com 4 clicks.'},
...
{id:'cobrinhas',name:'Cobrinhas Sensoriais',price:'R$ 13,00',cat:'sensoriais',label:'Sensoriais',img:'assets/cobrinhas.webp',gallery:['assets/gallery/cobrinhas-1.webp','assets/gallery/cobrinhas-2.webp'],short:'Kit com 3 cobrinhas articuladas P/M/G.',desc:'Cobrinhas articuladas que acompanham o movimento das mãos e proporcionam exploração tátil, coordenação motora e criatividade.',extra:'Vendidas em kit com 3 unidades nos tamanhos P, M e G. Valor a partir de R$ 14,00.\n[[AFL_SHIP:{"weight_g":25,"length_cm":15,"width_cm":10,"height_cm":4}]]'},
{id:'dado',name:'Dado Infinito',price:'R$ 18,00',cat:'sensoriais',label:'Sensoriais',img:'assets/dado.webp',gallery:['assets/gallery/dado-1.webp','assets/gallery/dado-2.webp'],short:'Movimento contínuo e envolvente.',desc:'Brinquedo sensorial articulado que muda de forma continuamente nas mãos. Compacto, divertido e ótimo para explorar movimentos.',extra:'Produzido em PLA por impressão 3D.\n[[AFL_SHIP:{"weight_g":38,"length_cm":4,"width_cm":4,"height_cm":4}]]'},
{id:'deus-fiel',name:'Letreiro “Deus é Fiel”',price:'R$ 40,00',cat:'crista',label:'Decoração Cristã',img:'assets/deus-fiel.webp',gallery:['assets/gallery/deus-fiel-1.webp'],short:'Uma mensagem de fé para decorar.',desc:'Letreiro decorativo cristão em impressão 3D com a mensagem “Deus é Fiel”. Uma peça delicada para salas, quartos, escritórios ou espaços de oração.',extra:'Produzido em PLA. Cores podem variar conforme disponibilidade.\n[[AFL_SHIP:{"weight_g":144,"length_cm":23,"width_cm":3,"height_cm":9}]]'},
...
{id:'dragao',name:'Dragão Articulado 60 cm',price:'R$ 60,00',cat:'colecionaveis',label:'Colecionáveis',img:'assets/dragao.webp',gallery:['assets/gallery/dragao-1.webp','assets/gallery/dragao-2.webp'],short:'Dragão articulado de grande impacto visual.',desc:'Dragão articulado produzido em impressão 3D, com aproximadamente 60 cm de comprimento e acabamento multicolorido.',extra:'Ideal para colecionadores, fãs de fantasia, decoração e presentes.\n[[AFL_SHIP:{"weight_g":127,"length_cm":60,"width_cm":10,"height_cm":5}]]'},
{id:'ele-vive',name:'Letreiro “Ele Vive”',price:'R$ 40,00',cat:'crista',label:'Decoração Cristã',img:'assets/ele-vive.webp',gallery:['assets/gallery/ele-vive-1.webp','assets/gallery/ele-vive-2.webp','assets/gallery/ele-vive-3.webp'],short:'Peça marcante com mensagem cristã.',desc:'Letreiro decorativo “Ele Vive” em impressão 3D, com combinação de cores de forte presença e acabamento elegante.',extra:'Ideal para salas, quartos, escritórios, igrejas e espaços de oração.\n[[AFL_SHIP:{"weight_g":111,"length_cm":20,"width_cm":3,"height_cm":10}]]'},
{id:'gracas',name:'Letreiro “Em Tudo Dai Graças”',price:'R$ 38,00',cat:'crista',label:'Decoração Cristã',img:'assets/dai-gracas.webp',gallery:['assets/gallery/gracas-1.webp'],short:'Mensagem de gratidão para o lar.',desc:'Peça decorativa cristã com a mensagem “Em Tudo Dai Graças”, produzida em impressão 3D com design moderno e elegante.',extra:'Uma ótima opção para decoração e presente.\n[[AFL_SHIP:{"weight_g":89,"length_cm":18,"width_cm":2,"height_cm":12}]]'},
{id:'espiral',name:'Espiral Sensorial',price:'M R$ 35,00 • P R$ 28,00',variants:[{id:'m',label:'Tamanho M',price:'R$ 35,00',shipping:{weight_g:85,length_cm:17,width_cm:17,height_cm:8}},{id:'p',label:'Tamanho P',price:'R$ 28,00',shipping:{weight_g:52,length_cm:10,width_cm:10,height_cm:7}}],cat:'sensoriais',label:'Sensoriais',img:'assets/espiral.webp',gallery:['assets/gallery/espiral-1.webp','assets/gallery/espiral-2.webp'],short:'Movimento, formas e efeito visual.',desc:'Espiral sensorial com efeito de movimento e transformação. Seu formato geométrico cria diferentes desenhos conforme é manipulada.',extra:'Disponível nos tamanhos M e P.'},
{id:'estrela',name:'Estrela Sensorial',price:'R$ 60,00',cat:'sensoriais',label:'Sensoriais',img:'assets/estrela.webp',gallery:['assets/gallery/estrela-1.webp','assets/gallery/estrela-2.webp'],short:'Textura articulada em formato de estrela.',desc:'Estrela sensorial articulada formada por diversos pequenos segmentos móveis para uma experiência tátil diferente e divertida.',extra:'Recomendada para maiores de 3 anos.\n[[AFL_SHIP:{"weight_g":122,"length_cm":12,"width_cm":2.5,"height_cm":12}]]'},
...
function render(){
  ...
  document.querySelectorAll('.card-photo').forEach(photo=>{
    ...
    const id=photo.closest('.card')?.querySelector('[data-view]')?.dataset.view;
    if(!id)return;
    photo.onclick=()=>openModal(id);
    photo.onkeydown=e=>{if(e.key==='Enter'||e.key===' '){e.preventDefault();openModal(id);}};
  });
